  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        'http://localhost:5000/diseaseDetect/classifyDisease/Cassava',
        formData,
        {
  ...
  return (
    <div>
      ...
      <div className="max-w-md p-6 mx-auto mt-40 bg-white border border-gray-300 rounded-lg shadow-lg">
        <h2 className="text-2xl font-bold text-black">Cassava Disease Detection</h2>
        <p className="mb-4 text-black">
          Upload an image of your cassava plant to detect potential diseases.
        </p>
