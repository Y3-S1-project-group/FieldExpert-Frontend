...
const PurchaseReport = () => {
  ...
  const handlePrint = useReactToPrint({
    content: () => componentRef.current, // Print the content in the modal
  });

  // Fetch the monthly purchases by category from the backend
  useEffect(() => {
    axios
      .get("http://localhost:5001/api/inventory/calculateMonthlyPurchasesByCategory")
      .then((res) => {
        ...
        <div className="fixed inset-0 z-50 overflow-auto flex items-center justify-center">
          ...
          <div className="relative bg-white p-8 rounded-lg shadow-xl max-w-xl w-full">
            ...
            <div className="flex justify-between items-center mb-4">
              <h1><center>මාසික කෘෂිකාර්මික අයිතම වාර්තාව</center></h1>
              {/* Close button */}
              <button
